...
const Controller = _mgr.createInstance( require("./companys.controller") );
const auth = require("../../auth");
const Joi = require("joi");
const validation = require("express-validation");
const model = require("./companys.model");
...
router.post("/create", validation(model.validation.default) , Controller.method("createCompany"));
